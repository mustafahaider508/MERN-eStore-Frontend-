...
function W_customised() {
  ...
  return (
    ...
    {ProductData.filter((i)=>i.category=="women" && i.subcategory=="Customized").slice(0,2).map(i => {
      return (
        <>
        ...
        {ProductData.filter((i)=>i.category=="women" && i.subcategory=="Customized").map(i => {
          return (
            <>
