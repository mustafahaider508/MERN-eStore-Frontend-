...
function W_Bracelets_Rings() {
  ...
  return (
    ...
    {ProductData.filter((i)=>i.category=="women" && i.subcatagory=="bracciali e anelli").slice(0,2).map(i => {
      return (
        <>
        ...
        {ProductData.filter((i)=>i.category=="women" && i.subcatagory=="bracciali e anelli").map(i => {
          return (
            <>
...
export default W_Bracelets_Rings
