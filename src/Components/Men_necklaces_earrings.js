...
function Men_necklaces_earrings() {
  ...
  return (
    ...
    {ProductData.filter((i)=>i.category=="men" && i.subcatagory=="collane e orecchini").slice(0,2).map(i => {
      return (
        <>
        ...
        {ProductData.filter((i)=>i.category=="men" && i.subcatagory=="collane e orecchini").map(i => {
          return (
            <>
