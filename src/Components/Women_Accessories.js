        ...
        <Container style={{marginTop:"30px"}} maxWidth="lg">
          ...
          <Grid container>
              ...
              <Grid container spacing={3}>
                ...
                <Card    style={{height:"50vh",borderRadius:"10px"}} sx={{ maxWidth: 440 }}>
                <img  style={{width:"100%",height:"50vh"}} src="womenv.jpeg" alt='' />

                </Card>
                <p style={{backgroundColor:"#9c1003",color:"white",width:370,fontSize: "25px",
              fontFamily: "Georgia, 'Times New Roman', Times, serif",textAlign:"center",textTransform:"capitalize" }}>Vintage</p>
                ...
                <p style={{backgroundColor:"#9c1003",color:"white",width:"370px",fontSize: "25px",
