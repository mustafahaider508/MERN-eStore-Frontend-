...
function Men_necklaces_earrings() {
  ...
  return (
    ...
    {ProductData.filter((i)=>i.category=="men" && i.subcatagory=="bracciali e anelli").slice(0,2).map(i => {
      return (
        <>
        ...
        {ProductData.filter((i)=>i.category=="men" && i.subcatagory=="bracciali e anelli").map(i => {
          return (
            <>
